...
export class MainMenuScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add
      .text(width / 2, height / 2 - 100, "pokeSlyer", {
    ...
    this.add
      .text(width / 2, height / 2 - 46, "덱빌딩 로그라이크", {
        fontFamily: '"Neo둥근모", monospace',
        fontSize: "16px",
        color: "#555577",
      })
    ...
    if (existingSave) {
      const continueBtn = this.add
        .text(width / 2, btnY + 68, `이어하기  (${existingSave.floor}층)`, {
          fontFamily: '"Neo둥근모", monospace',
          fontSize: "26px",
          color: "#aaaaff",
      ...
      continueBtn.on("pointerout", () =>
        continueBtn.setStyle({ color: "#aaaaff" }),
      );
