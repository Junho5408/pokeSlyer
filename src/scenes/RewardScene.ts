...
// 보상 풀: STARTER 제외 카드
const REWARD_POOL = starterCards
...
export class RewardScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    this.add
      ...
      .setOrigin(0.5);
    this.add
      .text(width / 2, 96, "카드 1장을 선택하여 덱에 추가하세요", {
        fontFamily: '"Neo둥근모", monospace',
        fontSize: "15px",
        color: "#aaaaaa",
      })
  ...
  private buildCardChoice(
    ...
    c.add(
      this.add
        .text(-cardW / 2 + 16, -cardH / 2 + 16, String(def.cost), {
          fontFamily: '"Neo둥근모", monospace',
          fontSize: "14px",
          color: "#ffdd44",
        })
    ...
    c.add(
      this.add
        .text(0, -cardH / 2 + 84, def.description, {
          fontFamily: '"Neo둥근모", monospace',
          fontSize: "12px",
          color: "#dddddd",
    ...
    c.add(
      this.add
        .text(0, cardH / 2 - 14, def.rarity, {
          fontFamily: '"Neo둥근모", monospace',
          fontSize: "13px",
          color: rarityColor[def.rarity] ?? "#cccccc",
        })
        .setOrigin(0.5),
    );
  }
